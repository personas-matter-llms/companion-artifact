...
ROLE_TO_TASK_TYPE = {
    "R1": "Code Review",
    "R2": "Code Review",
    "R3": "Code Review Supervision",
}
ROLE_TO_TASK_FILE = {
    "R1": "r1_writer_task.md",
    "R2": "r2_writer_task.md",
    "R3": "supervisor_task.md",
}
ROLE_TO_DISPLAY_NAME = {
    "R1": "Pull Request Review Writer",
    "R2": "Pull Request Review Writer",
    "R3": "Pull Request Review Supervisor",
}
NEUTRAL_TRAIT_NOTE = (
...
def fill_prompt(template, role, task_type, task_desc, cons, openness, extra, emotion):
    display = ROLE_TO_DISPLAY_NAME.get(role, role)
    filled = (
        template
    ...
    return add_neutral_trait_note(filled, cons, openness, extra)
